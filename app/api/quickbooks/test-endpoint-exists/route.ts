...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('=== ENDPOINT EXISTENCE TEST ===')
    ...
    const endpointTests = [
      ...
      {
        name: 'POST /customer (our current approach)',
        url: `${baseUrl}/v3/company/${realmId}/customer?minorversion=40`,
        method: 'POST',
      ...
      {
        name: 'GET /customer/1 (check if specific customer endpoint exists)',
        url: `${baseUrl}/v3/company/${realmId}/customer/1?minorversion=40`,
        method: 'GET'
      }
    ]
    ...
    return NextResponse.json({
      success: true,
      message: 'Endpoint existence testing completed',
      results,
      summary
    })
